...
- 一个刚开始尝试使用Mac来办公的审计员加完班玩Trae捣鼓出来的东西(工作还是不够饱和)，完全不懂代码，主打一个奴役AI。
- Mac上几乎找不到Excel和WPS的插件，想着既然没有那就自己做，一键添加Round和移除Round是我用得最多的功能了，后续刷底稿看看还有什么小功能能折腾一下。
